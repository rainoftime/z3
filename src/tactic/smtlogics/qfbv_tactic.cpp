...
static tactic * mk_klee_qfbv_preamble(ast_manager& m, params_ref const& p) {
...
static tactic * mk_klee_qfbv_tactic(ast_manager& m, params_ref const & p, tactic* sat, tactic* smt) {
    tactic* preamble_st = mk_klee_qfbv_preamble(m, p);
...
tactic * mk_qfbv_tactic(ast_manager & m, params_ref const & p) {
    //std::cout << "The INSTANCE is in QF_BV!!!\n";
...
#else 
    return mk_klee_qfbv_tactic(m, p, new_sat, mk_smt_tactic(m, p));
